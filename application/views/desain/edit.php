        ...
        <div class="panel">
            ...
            <div class="panel-body container-fluid">
                <div class="row row-lg">
                    <div class="col-xl-6">
                        <form id="regForm" enctype="multipart/form-data" method="post" action="<?= base_url('desain/update');  ?>">
                            ...
                            <div class="tab">
                                ...
                                ?>
                                <input type="text" name="jumlah_pendesain" id="jumlah_pendesain" class="form-control" value="<?= $totalPegawai ?>" readonly></input>
                                <table class="table table-bordered mytable mt-10" id="mytable">
                                    <?php $i = 1; ?>
                                    <?php foreach ($pendesain as $kp) { ?>
                                        <tr>
                                            <td>
