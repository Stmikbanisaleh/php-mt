        ...
        <div class="panel">
            ...
            <div class="panel-body container-fluid">
                <div class="row row-lg">
                    <div class="col-xl-6">
                        <form id="regForm" enctype="multipart/form-data" method="post" action="<?= base_url('merek/save');  ?>">
                            ...
                            <div class="tab">
                                ...
                                <input type="text" class="inputfield form-control" name="kelas" id="kelas" placeholder="Kelas Barang dan Jasa">
                                Unit Kerja
                                ...
                                <table class="table table-bordered mytable" id="mytable">
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a type="button" href="<?= base_url('merek/input_pendesain') ?>" class="my-5 btn btn-success btn-sm">Add</a>
                                        </td>
                                    </tr>
