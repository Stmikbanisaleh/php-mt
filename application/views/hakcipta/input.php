        ...
        <div class="panel">
            ...
            <div class="panel-body container-fluid">
                <div class="row row-lg">
                    <div class="col-xl-6">
                        <form id="regForm" enctype="multipart/form-data" method="post" action="<?= base_url('hakcipta/save');  ?>">
                            ...
                            <div class="tab">
                                ...
                                Jumlah Pencipta
                                <input type="text" name="jumlah_pencipta" id="jumlah_pencipta" onkeyup="check_jumlah()" placeholder="(Max 20)" class="form-control"></input>
                                ...
                                <table class="table table-bordered mytable" id="mytable">
                                    <tr>
                                        <td>
                                            <select name="pencipta[1][nik]" id="nik_1" class="selectfield form-control">
                                                <option value="">Pilih Pencipta Utama</option>
                                        ...
                                        <td>
                                            ...
                                            <a type="button" href="<?= base_url('hakcipta/input_pencipta') ?>" class="my-5 btn btn-success btn-sm">Add</a>
                                        </td>
                                    </tr>
                                    <small>Jika pencipta Non Pegawai belum terdaftar klik tombol Add!</small>
                                </table>
                                <div class="progress my-10">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $(".add-row-one").click(function() {
            var row = $('#mytable').find('tr').length;
            var nextRow = row + 1;
            var markup = "<tr><td><select name='pencipta[" + nextRow + "][nik]' id='nik_" + nextRow + "' class='selectfield form-control'><option value=''>Pilih Pencipta</option>";
            <?php foreach ($pegawai as $pg) : ?>
    ...
    function validateForm() {
        ...
        if (o.value == "") {
            // add an "invalid" class to the field:
            o.className += " text-danger invalid-feedback";
            // and set the current valid status to false
            valid = false;
        }
        //cek unit kosong
